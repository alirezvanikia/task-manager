<template>
  <div :class="{ active: !isCompleted }" class="task-manager-card">
      ...
      <div class="task-manager-card__informations">
          ...
          <div v-if="isC" class="task-manager-card__timer">
              ...
              <div class="task-manager-card-container">
                <div class="task-manager-card-container">
                  <taskCard v-for="task in completedTasks" :key="task.id" :title="task.title" :type="task.type"
                    ...
                    :completedTime="task.completedTime" :completed-elapsed-time="task.elapsedTime" @detail-task="showTaskDetails(task.id)"
