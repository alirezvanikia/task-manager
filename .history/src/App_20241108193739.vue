...
export default {
  ...
  methods: {
    ...
    async addTask() {
      if (this.newTaskTitle) {
        try {
          ...
          const response = await axios.post('https://672ddbaffd8979715643fdfd.mockapi.io/api/v1/tasks', newTask);
    ...
    async deleteTask(id) {
      try {
        await axios.delete(`https://672ddbaffd8979715643fdfd.mockapi.io/api/v1/tasks/${id}`);
