<template>
    <div :class="{ active: !isCompleted }" class="task-manager-card">
        ...
        <div class="task-manager-card__informations">
            ...
            <div class="task-manager-card__timer">
                {{ formattedCompletedElapsedTime }} <!-- Show final or current time -->
            </div>
...
export default {
    props: {
        ...
        completedElapsedTime: { // Prop to display completion time
            type: String,
            default: ''
        },
    ...
    methods: {
        formattedCompletedElapsedTime() {
      return (this.completedElapsedTime;
    },
        // Start timer
        startTimer() {
            if (!this.isCompleted) {
