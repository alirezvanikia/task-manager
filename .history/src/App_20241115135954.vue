        ...
        <div class="col-lg-6">
          <div class="task-manager-box task-manager-box__attendance-time">
            ...
            <div class="task-manager-box__attendance-btn">
              ...
              <button @click="absence" v-else class="btn btn--green me-auto">log out</button>
            </div>
          </div>
          <div class="task-manager-box">
            <div class="task-manager-values">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="task-manager-input">
                    <textarea class="task-manager-input__inner" v-model="newTaskDescription" placeholder="Description of the task"
