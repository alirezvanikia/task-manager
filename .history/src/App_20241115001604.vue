    ...
    filteredCompletedTasks() {
      if (this.selectedDate) {
        return this.tasks.filter(task =>
          task.isCompleted && task.completedTime && task.completedTime.startsWith(this.selectedDate) ||
          !task.isCompleted && task.createdTime && task.createdTime.startsWith(this.selectedDate)
        );
      }
