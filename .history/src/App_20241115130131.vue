            ...
            <div class="task-manager-history">
              ...
              <div class="task-manager-card-container">
                <taskCard v-for="task in filteredCompletedTasks" :key="task.id" :title="task.title" :type="task.type"
                  ...
                  :completedTime="task.completedTime" :completed-elapsed-time="task.elapsedTime"  :completed-elapsed-hour="task. :completed-elapsed-time="task.elapsedTime""
...
export default {
  ...
  methods: {
    ...
    completeTask(completedTime, id, elapsedTime, elapsedHour) {
      ...
      if (task) {
        ...
        task.elapsedHour = elapsedHour; // Record the elapsed time to complete the task
      }
    },
