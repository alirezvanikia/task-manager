              ...
              <div class="task-manager-card-container">
                <div class="task-manager-card-container">
                  <taskCard v-for="task in completedTasks" :key="task.id" :title="task.title" :type="task.type"
                    ...
                    :completedTime="task.completedTime" @detail-task="showTaskDetails(task.id)":completedElapsedTime="task.completedElapsedTime" <!-- ارسال زمان سپری شده --></taskCard> @end-task="completeTask" />
                </div>
